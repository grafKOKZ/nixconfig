...
hl.animation({ leaf = "windows",       enabled = true,  speed = 2.5,  bezier = "easeInOutCubic" })
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 2.5,  bezier = "easeInOutCubic" })
...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 1.21, bezier = "almostLinear", style = "slidefade 20%" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 1.94, bezier = "almostLinear", style = "slidefade 20%" })
