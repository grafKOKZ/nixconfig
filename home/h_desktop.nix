...

{
  home = {
    ...
    file.".local/share/PrismLauncher/themes/catppuccin/theme.json".source = ./1080dots/PrismLauncher/themes/catppuccin/theme.json;
    file.".local/share/PrismLauncher/themes/catppuccin/themeStyle.css".source = ./1080dots/PrismLauncher/themes/catppuccin/themeStyle.css;
  };
}
